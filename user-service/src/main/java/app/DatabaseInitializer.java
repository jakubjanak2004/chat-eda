...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    private void createAdmin(ChatUser chatUser) {
        ...
        if (generator.userExistsByUsername(adminSeedProperties.username())) return;
        ...
        generator.saveChatUser(adminChatUser);
    ...
    private void createTestUsers(int count, String password, int chatCount, int messagesCount) {
        ...
        List<Chat> savedChatList = generator.saveAllChats(chatList);
...
//                    .responseTo(responseTo)
        ...
        generator.saveAllMessages(messageList);
    }
}
